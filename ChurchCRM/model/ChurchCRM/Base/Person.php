        ...
        if (null === $this->collWhyCames || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collWhyCames) {
                    ...
                    $collWhyCames = new $collectionClassName;
                    $collWhyCames->setModel('\ChurchCRM\WhyCame');
        ...
        if (null === $this->collNotes || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collNotes) {
                    ...
                    $collNotes->setModel('\ChurchCRM\Note');
        ...
        if (null === $this->collPerson2group2roleP2g2rs || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPerson2group2roleP2g2rs) {
                    ...
                    $collPerson2group2roleP2g2rs->setModel('\ChurchCRM\Person2group2roleP2g2r');
        ...
        if (null === $this->collEventAttends || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEventAttends) {
                    ...
                    $collEventAttends = new $collectionClassName;
                    $collEventAttends->setModel('\ChurchCRM\EventAttend');
        ...
        if (null === $this->collPrimaryContactpeople || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPrimaryContactpeople) {
                    ...
                    $collPrimaryContactpeople = new $collectionClassName;
                    $collPrimaryContactpeople->setModel('\ChurchCRM\Event');
        ...
        if (null === $this->collSecondaryContactpeople || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collSecondaryContactpeople) {
                    ...
                    $collSecondaryContactpeople = new $collectionClassName;
                    $collSecondaryContactpeople->setModel('\ChurchCRM\Event');
        ...
        if (null === $this->collPledges || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPledges) {
                    ...
                    $collPledges->setModel('\ChurchCRM\Pledge');
