...
class PersonTableMap extends TableMap
{
     ...
     */
    const COL_PER_NATIONALID = 'person_per.per_NationalId';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('per_NationalId', 'NationalId', 'VARCHAR', false, 50, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PersonTableMap::COL_PER_NATIONALID);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.per_NationalId');
        }
    }
